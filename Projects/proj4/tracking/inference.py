...
class ParticleFilter(InferenceModule):
    ...
    def initializeUniformly(self, gameState):
        ...
        numLegal = len(legalPos)

        for particleNum in range(self.numParticles):
            self.particles.append(self.legalPositions[particleNum % numLegal])
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for particlePos in self.particles:
            ...
            beliefDist[particlePos] += self.getObservationProb(
                observation, pacmanPos, particlePos, jailPos)
        ...
        if beliefDist.total() == 0:
            ...
            self.particles = [beliefDist.sample()
                              for particleNum in range(self.numParticles)]
    ...
    def elapseTime(self, gameState):
        ...
        for particleNum in range(self.numParticles):
            ...
            newPosDist = self.getPositionDistribution(
                gameState, self.particles[particleNum])
            self.particles[particleNum] = newPosDist.sample()
...
class JointParticleFilter(ParticleFilter):
    ...
    def initializeUniformly(self, gameState):
        ...
        self.particles = list(itertools.product(
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for particlePos in self.particles:
            ...
            for i in range(self.numGhosts):
                ...
                prod *= self.getObservationProb(
                    observation[i], pacmanPos, particlePos[i], jailPos)

            beliefDist[particlePos] += prod
